...
class ClienteDaoObject extends \Parm\DataAccessObject implements ClienteTable
{
    ...
    */
    ...
    /**
    * Set  field cliente.id in logical database "empresacrud"
    * @param int|null $val
    */
    ...
    /**
    * Set  field cliente.nombres in logical database "empresacrud"
    ...
    */
    ...
    /**
    * Get  field cliente.nombres from logical database "empresacrud"
    * @return string|null
    */
    ...
    /**
    * Set  field cliente.ciudad in logical database "empresacrud"
    * @param string|null $val
    */
    ...
    /**
    * Get  field cliente.ciudad from logical database "empresacrud"
    * @return string|null
    */
    ...
    /**
    * Set  field cliente.sexo in logical database "empresacrud"
    * @param string|null $val
    */
    ...
    /**
    * Get  field cliente.sexo from logical database "empresacrud"
    * @return string|null
    */
    ...
    /**
    * Set  field cliente.telefono in logical database "empresacrud"
    * @param string|null $val
    */
    ...
    /**
    * Get  field cliente.telefono from logical database "empresacrud"
    * @return string|null
    */
    ...
    /**
    * Set  field cliente.fecha_nacimiento in logical database "empresacrud"
    ...
    */
    ...
    {
        $this->setDateFieldValue(self::FECHA_NACIMIENTO_COLUMN,$val);
    }

    /**
    * Get  field cliente.fecha_nacimiento from logical database "empresacrud"
    ...
    */
    ...
    {
        return $this->getDateFieldValue(self::FECHA_NACIMIENTO_COLUMN,$format);
    }

    /**
    * Get  field cliente.fecha_nacimiento from logical database "empresacrud" as a DateTime object
    * @return \DateTime|null
    */
    public function getFechaNacimientoDateTimeObject()
    {
        return $this->getDatetimeObjectFromField(self::FECHA_NACIMIENTO_COLUMN,$this->getFactory()->getDateStorageFormat());
    }
